      ...
      <header id={header_id}>
        <div class="d-flex flex-column">
          ...
          <nav id="navbar" class="nav-menu navbar">
            <ul>
              <li><a href="/dashadmin" class="nav-link scrollto active"><Icon icon="bx:home" /> <span>&nbsp; Home</span></a></li>
              <li><a href="/verifsk" class="nav-link scrollto"><Icon icon="bx:book-bookmark" /> <span>&nbsp; Surat Kematian</span></a></li>
              <li><a href="/manageuser" class="nav-link scrollto"><Icon icon="bx:book-heart" /> <span>&nbsp; Manage User</span></a></li>
